...
<td><font face="verdana"><b>duración de la jornada</b></font></td>
	...
	<?php
        ...
        //$registros=mysqli_query($conexion,"select * from conexion where proyecto ='$_POST[idproyecto]' and fecha='$_POST[fecha]'") or
		$registros=mysqli_query($conexion,"select * from agentes where proyecto ='$_POST[idproyecto]' and fecha between '$_POST[fechainicio]' AND '$_POST[fechafin]'") or
